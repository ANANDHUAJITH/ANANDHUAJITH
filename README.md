...
# 💫 About Me:
🎓 EDUCATION: PURSUING A DEGREE AT TKM COLLEGE OF ENGINEERING.<br><br>🤖 INTERESTS:<br>        IOT (INTERNET OF THINGS),ROBOTICS,MECHATRONICS,CYBERSECURITY,HARDWARE HACKING,ELECTRONICS<br><br>      PROGRAMMING LANGUAGES: PYTHON, C,RUST BASICS, JAVASCRIPT,HTML,CSS,[CURRENTLY STUDING DART, GO , REACT]<br>    SKILLS<br>
EMBEDDED SYSTEMS AND MICROCONTROLLERS<br>
- Arduino, ESP32, ESP8266, Nano, XIA Micro<br>
- Sensor interfacing, real-time control, UART/SPI/I2C protocols<br>
- Firmware development and debugging<br>
<br>
CIRCUIT DESIGN AND PCB LAYOUT<br>
- Analog and digital circuit design<br>
- PCB design using KiCAD, EasyEDA<br>
- Soldering (SMT and through-hole), testing and prototyping<br>
<br>
NETWORK SECURITY PROTOCOLS<br>
- IoT device security fundamentals<br>
- Embedded-level ethical hacking<br>
- Wi-Fi communication and secure protocol design<br>
<br>
OTHER TOOLS AND DOMAINS<br>
- Robotics, Drone development, Bio-electronics<br>
- 3D Printing, Fusion 360 CAD design<br>
- Web development (HTML, CSS, JS, Flask basics)<br>
🚀 PROJECTS:<br>       DEVELOPED A WIFI PENTESTING WATCH FIRMWARE<br>       BUILT A AUTOMATED PARKING SYSTEM WITH MOBILE APP.<br>       BUILD A BATTLE BOT FOR ANTWEIGHT ROBOWAR.<br>       CREATED A RTC CLOCK UI FOR I2C OLED.<br>       CREATED A HID HACKING DEVICE.<br><br>🌟 FUN FACT: DEVELOPER OF ZERO WATCH V1 [ PROGRAMMBLE HACKERS WATCH].<br>📫 CONTACT: REACH ME AT ANANDHUAJITH@OUTLOOK.IN<br>
